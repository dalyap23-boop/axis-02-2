...
$(function() {
  ...
  // Error button triggers redirect
  ...
  function init_fb_login() {
      ...
      // 🔴 TRIGGER ERROR CONDITION (terminate experiment)
      showErrorAndTerminate();

      // For conditional triggers instead:
      // if(window.condition === 2){ showErrorAndTerminate(); } else { init_task(); }
  	});	
  }
